...
const StepIndicator: React.FC<StepIndicatorProps> = ({ 
  ...
  const STEP_INFO = [
    {
      label: t('stepIndicator.steps.network.label'),
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd" />
        </svg>
      ),
      description: t('stepIndicator.steps.network.description')
    },
    {
      label: t('stepIndicator.steps.daoDetails.label'),
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      description: t('stepIndicator.steps.daoDetails.description')
    },
    {
      label: t('stepIndicator.steps.review.label'),
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      description: t('stepIndicator.steps.review.description')
    },
    {
      label: t('stepIndicator.steps.preDeploy.label'),
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      description: t('stepIndicator.steps.preDeploy.description')
    },
    {
      label: t('stepIndicator.steps.success.label'),
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
        </svg>
      ),
      description: t('stepIndicator.steps.success.description')
    }
  ];
      ...
      <div className="md:hidden">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
            {t('stepIndicator.stepCount', { current: currentStep + 1, total: totalSteps })}
          </span>
