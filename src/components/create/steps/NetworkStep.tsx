    ...
    <div className="space-y-6">
      <div className="bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg p-6 mb-6">
        <h3 className="text-lg font-medium text-primary-800 dark:text-primary-300 mb-3 flex items-center">
          ...
          First, Choose Your Network
        </h3>
        <p className="text-primary-700 dark:text-primary-400 mb-4">
          Select the blockchain network where you want to deploy your DAO. Each network has different characteristics:
        </p>
        <ul className="list-disc pl-5 space-y-2 text-primary-700 dark:text-primary-400">
          <li><strong>Ethereum Mainnet:</strong> The primary Ethereum blockchain with highest security but higher gas fees</li>
          <li><strong>Layer 2 Networks:</strong> Optimism, Arbitrum, etc. offer lower fees while inheriting Ethereum security</li>
          <li><strong>Alternative L1s:</strong> Networks like Avalanche, BNB Chain offer different trade-offs</li>
          <li><strong>Testnets:</strong> For testing before deploying to mainnet (free to use)</li>
        </ul>
      </div>
      ...
      {isWrongNetwork ? (
                ...
                {isSwitchingNetwork ? (
                  ...
                  <>
                    <p className="text-yellow-700 dark:text-yellow-300 flex-1">
                      Failed to switch network. Please check your wallet and try again.
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="network" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                Network
                <InfoTooltip text="The blockchain network where your DAO will be deployed. Each network has different characteristics and fees." />
              </label>
            ...
            <div>
              <label htmlFor="version" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                DAO Version
                <InfoTooltip text="The version of the DAO contracts to deploy. Newer versions may include additional features or improvements." />
              </label>
              <VersionSelect
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Network Features</h3>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FeatureCard
                title="Governance System"
                description="Full on-chain governance with proposal creation, voting, and execution"
                icon={
              ...
              <FeatureCard
                ...
                description="Secure treasury for managing DAO assets with multi-sig security"
                icon={
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <FeatureCard
                title="Token System"
                description="ERC20 governance token with customizable parameters and distribution"
                icon={
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <FeatureCard
                ...
                description="Time-based staking with voting power multipliers for long-term holders"
                icon={
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          ...
          {chainId === 11155111 && (
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4">
              <p className="text-blue-700 dark:text-blue-300 text-sm">
                <strong>Note:</strong> For fast testing, Sepolia DAOs are deployed with a 5-minute voting period.
              </p>
            </div>
          )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Central governance hub for proposals, voting, and execution of community decisions
                </p>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  ERC20 governance token with customizable tax mechanisms and distribution controls
                </p>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Secure vault for managing DAO assets, controlled by governance proposals
                </p>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Time-based staking with voting power multipliers for long-term holders
                </p>
              </div>
            </div>
